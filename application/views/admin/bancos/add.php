            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>mantenimiento/bancos/store" method="POST">
                              <div class="form-group">
                                <label for="ban_descri">Descripción:</label>
                                <input type="text" class="form-control" id="ban_descri" name="ban_descri">
                            </div>
                              <div class="form-group">
                                <label for="ban_agente">Agente:</label>
                                <input type="text" class="form-control" id="ban_agente" name="ban_agente">
                            </div>
                              <div class="form-group">
                                <label for="ban_telefono">Teléfono:</label>
                                <input type="text" class="form-control" id="ban_telefono" name="ban_telefono">
                            </div>
                            <div class="form-group">
                               <div class="col-md-6">
