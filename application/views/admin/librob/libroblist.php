...
<main id="main" class="main">
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Libro Banco</li>
        </ol>
    </nav>
                            ...
                            <div class="card border">
                                <div class="card-body">
                                    <form class="row g-3 mb-4 mt-2"
                                        action="<?php echo base_url();?>mantenimiento/LibroBanco/mostrarLibroBanco" method="post">
                                        <table class="table table-hover table-bordered table-sm rounded-3 mt-4"
                                                    ...
                                                    <thead class="align-middle">
                                                        <tr>
                                                            ...
                                                            <th class="columna-ancha">Generar Banco</th>
