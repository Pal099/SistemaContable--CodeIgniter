                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="card border">
                                <div class="card-body">
                                    <form method="GET" action="<?php echo base_url(); ?>ejecucionp" class="form-horizontal">
                                                ...
                                                <div class="modal-body">
                                                    <table class="table table-hover table-sm" id="TablaCuentaCont1">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr onclick="selectCC('<?= $c->id ?>','<?= $c->codigo ?>','<?= $c->nombre ?>')"
                                    ...
                                    <div class="table-responsive mt-4">
                                        <table class="table table-bordered table-hover" id="tablaEjecucion">
                                            ...
                                            <tbody>
                                                <?php if (!empty($ejecucionpresupuestaria)): ?>
                                                    <?php foreach ($ejecucionpresupuestaria as $item): ?>
                                                        <tr>
                                                            <td><?= $item->Idcuentacontable ?></td>
                                                            <td><?= $item->origen_de_financiamiento_id_of ?></td>
                                                            <td><?= $item->fuente_de_financiamiento_id_ff ?></td>
                                                            <td><?= $item->programa_id_pro ?></td>
                                                            <td class="text-end"><?= number_format($item->TotalPresupuestado, 0, ',', '.') ?></td>
                                                            <td class="text-end"><?= number_format($item->TotalModificado, 0, ',', '.') ?></td>
                                                            <td class="text-end"><?= number_format($item->Vigente, 0, ',', '.') ?></td>
                                                            <td class="text-end"><?= number_format($item->Obligado, 0, ',', '.') ?></td>
                                                            <td class="text-end"><?= number_format($item->Pagado, 0, ',', '.') ?></td>
                                                            <td class="text-end"><?= number_format($item->SaldoPresupuestario, 0, ',', '.') ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </tbody>
                                        ...
                                        async function generarPDFEjecucion() {
                                            ...
                                            <?php foreach($ejecucionpresupuestaria as $item): ?>
                                                data.push({
                                                    ...
                                                    origen: '<?= $item->origen_de_financiamiento_id_of ?>',
                                                    fuente: '<?= $item->fuente_de_financiamiento_id_ff ?>',
                                                    programa: '<?= $item->programa_id_pro ?>',
...
<!-- Incluir scripts de DataTable al final -->
