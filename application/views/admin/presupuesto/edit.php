...
<body>
                                        ...
                                        <div class="card border">
                                            <div class="card-body">
                                                <div class="row g-3 align-items-center mt-2">
                                                    ...
                                                    <!-- En este ciclo se busca el id del origen, una vez encuentra ese id en el ciclo lo selecciona y lo muestra en el select -->
                                                    <div class="form-group col-md-4">
                                                    ...
                                                    <div class="collapse mt-4" id="camposMesesCollapse">
                                                        <div class="form-group">
                                                            ...
                                                            foreach ($meses as $par_meses): ?>
                                                                <div class="row mb-3">
                                                                    <?php foreach ($par_meses as $codigo => $nombre):
                                                                        // Obtener el valor del presupuesto mensual si existe
                                                                        $valor = isset($presupuestos_mensuales['pre_' . $codigo]) ?
                                                                            $presupuestos_mensuales['pre_' . $codigo] : '';
                                                                    ?>
                                                                        <div class="col-md-6">
                                                                            <label for="pre_<?php echo $codigo ?>">
                                                                                Presupuesto <?php echo $nombre ?>:
                                                                            </label>
                                                                            <input type="number"
                                                                                class="form-control"
    ...
    <!-- Script para mostrar los campos de los meses y mostrar automaticamente si es que tiene datos -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const switchElement = document.getElementById('camposOpcionalesSwitch');
            const collapseElement = document.getElementById('camposMesesCollapse');

            // Verificar si hay algún valor en los campos mensuales
            const hasMonthlyValues = <?php
                                        $has_values = false;
                                        if (isset($presupuestos_mensuales) && is_array($presupuestos_mensuales)) {
                                            foreach ($presupuestos_mensuales as $valor) {
                                        ...
                                        echo $has_values ? 'true' : 'false';
                                        ?>;

            // Activar el switch si hay valores
            if (hasMonthlyValues) {
            ...
            // Agregar evento al switch para mostrar/ocultar campos
