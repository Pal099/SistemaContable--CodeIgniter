                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="codcatalogo" name="codcatalogo"
                                                         required>
                                                    </div>
                                                    
                                                    <div class="form-group col-md-4">
                                                        <label for="descripcioncatalogo">Catalogo</label>
                                                        <input type="text" class="form-control" id="descripcioncatalogo" name="descripcioncatalogo"
                                                         required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="precioref">Precio Ref</label>
                                                        <input type="text" class="form-control" id="precioref"
                                                            name="precioref" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
