...
<div class="modal-container" id="modalContainer">
    <div class="modal-content">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php foreach ($num_asi_deta as $index => $num_asi_detas): ?>
                    <tr class="list-item" onclick="selectNum_asi_detas('<?= $pnum_asi_detas->monto_pago ?>', '<?= $num_asi_detas->debe ?>', '<?= $num_asi_detas->haber ?>', '<?= $num_asi_detas->camprobante ?>')">
                        <td><?= $index + 1 ?></td>
                        <td><?= $num_asi_detas->monto_pago ?></td>
                        <td><?= $num_asi_detas->debe ?></td>
                        <td><?= $num_asi_detas->haber ?></td>
                        <td><?= $num_asi_detas->comrpobante ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
