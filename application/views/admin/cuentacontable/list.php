                ...
                <div class="container-fluid d-flex flex-row justify-content-between">
                    ...
                    <div class="col-md-6 d-flex flex-row justify-content-end align-items-center mt-4">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo base_url(); ?>mantenimiento/CuentaContable/add'">
                                    ...
                                    <div class="card border">
                                        <div class="card-body mt-4">
                                            <div id="tablaContainer">
                                                <table class="table table-hover table-sm align-middle mt-4" id="CuentasContables">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Código</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-grid gap-1 d-md-flex justify-content-md-center">
                                                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalCuentasContables" value="<?php echo $cuentacontable->IDCuentaContable; ?>">
