        ...
        <div class="col-lg-12">
          <div class="row">
                    <div class="col-md-12" >
                            ...
                            <a href="<?php echo base_url();?>ReporteC/hojaEnBlanco/1" target="_blank" class="btn btn-success btn-flat"><i class="fa-regular fa-file-pdf"></i> Generar Reporte</a>
                                ...
                                <?php if(!empty($categorias)):?>
                                    <?php foreach($categorias as $categoria):?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-info btn-view-categoria" data-toggle="modal" data-target="#modal-default" value="<?php echo $categoria->id;?>">
