        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
              <span class="card-title">Usuario: <?php echo $this->session->userdata('Nombre_usuario'); ?></span>
            </p>
            <p>
                    <span class="card-title">Unidad Académica: <?php echo $this->session->userdata('unidad'); ?></span>
            </p>
