                                                                                    ...
                                                                                    <div class="table-responsive">
                                                                                        <table
                                                                                            ...
                                                                                            <?php foreach ($comprobantesPedido as $comprobanteP): ?>
                                                                                                <pre><?php print_r($comprobanteP); ?></pre>
                                                                                                <tr id="filaB"
                                                                                                    class="filaB">
                                                                                                    <td>
                                                                                                        <div
...
<script>
    ...
    data: JSON.stringify({
        datos: datosCompletos // Asegúrate de que datosCompletos esté correctamente estructurado
    }),
...
$(document).ready(function () {
    ...
    function actualizarValores(row) {
        ...
        if (row.find('.iva-checkbox').is(':checked')) {
            ...
            row.find('.porcentaje_iva').val('0');  // Limpiar el valor del IVA
