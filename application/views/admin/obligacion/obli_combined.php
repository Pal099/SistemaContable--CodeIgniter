                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" id="op"
                                                                        name="op"
                                                                        value="<?php echo isset($op_siguiente) ? $op_siguiente : $op_siguiente; ?>"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <script>
            function selectComprobante(id_unidad, fecha, ruc, idproveedor, razon_social, concepto, idpresupuesto, descripcion, id_pedido) {
                ...
                $.get('<?= base_url("obligaciones/diario_obligaciones/getDatosCompletosPresupuesto") ?>', {
                    ...
                    // data contiene todos los datos relacionados
                    if (data.presupuesto) {
                        $('#id_pro').val(data.presupuesto.programa_id_pro);
                        $('#id_ff').val(data.presupuesto.fuente_de_financiamiento_id_ff);
                        $('#id_of').val(data.presupuesto.origen_de_financiamiento_id_of);
                        $('#idcuentacontable').val(data.presupuesto.Idcuentacontable);
                    }
                    if (data.cuenta_contable) {
                        $('#codigo_cc').val(data.cuenta_contable.codigo_cc);
                        $('#descripcion_cc').val(data.cuenta_contable.descripcion_cc);
                    } else {
                        $('#codigo_cc').val('');
                        $('#descripcion_cc').val('');
                    }
            ...
            $(document).ready(function() {
                $("#formularioPrincipal").on("submit", function(e) {
                    ...
                    if (diferenciaActualizada === 0) {
                        ...
                        showToast('El debe y el haber no pueden ser diferentes, por favor revise lo ingresado.', 'text-bg-warning');
                    }
                });
