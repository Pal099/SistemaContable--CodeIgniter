                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex align-items-center">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="<?php echo base_url(); ?>obligaciones/diario_obligaciones/edit"
                                ...
                                <a href=" <?php echo base_url(); ?>obligaciones/diario_obligaciones/pdfs"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <form action="<?php echo base_url(); ?>obligaciones/diario_obligaciones/store"
                                    method="POST">
                                    <div class="content3">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo base_url(); ?>obligaciones/diario_obligaciones" class="btn btn-danger"><span
