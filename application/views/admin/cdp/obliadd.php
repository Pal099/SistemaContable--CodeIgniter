  ...
  <link rel="stylesheet" type="text/css" href="assets/style.css">
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo base_url();?>obligaciones/Certific_disp_presu">Diario de obligaciones</a></li>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form id="formPrincipal" action="<?php echo base_url();?>obligaciones/Certific_disp_presu/store" method="POST">
