...
<main id="main" class="content">
    ...
    <div class="content-container">
        <div class="pagetitle">
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Vista de Certificacion de Disponibilidad de Presupuesto</li>
                </ol>
            </nav>
            <h1>Certificacion de Disponibilidad de Presupuesto</h1>
        </div><!-- End Page Title -->
                ...
                <div class="row">
                    <div class="col-md-12 d-flex align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="<?php echo base_url(); ?>obligaciones/Certific_disp_presu/edit" class="btn btn-primary btn-flat"><span
                ...
                <div class="row">
                    <div class="col-md-10">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <form  action="<?php echo base_url(); ?>obligaciones/Certific_disp_presu/store" method="POST">
                                                    <div class="content3">
                                ...
                                <div class="row">
                                 ...
                                 <button type="submit" class="btn btn-success btn-flat"><span class="fa fa-save"></span>Guardar</button>
                                            ...
                                            <div class="col-md-6">
                                                <a href="<?php echo base_url(); ?>obligaciones/Certific_disp_presu" class="btn btn-danger"><span class="fa fa-remove"></span>Cancelar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php if (!empty($presupuestos)): ?>
                                <?php foreach ($presupuestos as $item): ?>
                                    <tr>
                                    <td contenteditable="true"><?php echo $item->ID_Presupuesto; ?></td>
                                    <td contenteditable="true"><select class="form-control" id="id_pro" name="id_pro">
                                                                <?php foreach ($programa as $prog): ?>
                                                                                    <option value="<?php echo $prog->id_pro; ?>"><?php echo $prog->nombre; ?></option>
                                                                <?php endforeach; ?></td>
                                    <td contenteditable="true"><select class="form-control" id="id_ff" name="id_ff">
                                                                <?php foreach ($fuente_de_financiamiento as $ff): ?>
                                                                                    <option value="<?php echo $ff->id_ff; ?>"><?php echo $ff->nombre; ?></option>
                                                                <?php endforeach; ?>
                                                            </select></td>
                                    <td contenteditable="true"><select class="form-control" id="id_of" name="id_of">
                                                                <?php foreach ($origen_de_financiamiento as $of): ?>
                                                                                    <option value="<?php echo $of->id_of; ?>"><?php echo $of->nombre; ?></option>
                                                                <?php endforeach; ?>
                                                            </select></td>
                                    <td contenteditable="true"><select class="form-control" id="idcuentacontable" name="idcuentacontable">
                                                <?php foreach ($cuentacontable as $cc): ?>
                                                    <option value="<?php echo $cc->IDCuentaContable; ?>">
                                                             <?php echo $cc->Codigo_CC . ' - ' . $cc->Descripcion_CC; ?>
                                                                </option>
                                    ...
                                    <td contenteditable="true">campo prueba</td>
                                    <td contenteditable="true">campo prueba</td>
                                    <td contenteditable="true">campo prueba</td>
                                    <td contenteditable="true">campo prueba</td>
                                    <td contenteditable="true">campo prueba</td>
        ...
        <?php if (!empty($data)): ?>
                                                                    <?php foreach ($data as $item): ?>
                                                                                        <tr>
                                                                                        <td contenteditable="true"><?php echo $item->ruc; ?></td>
                                                        <td contenteditable="true"><?php echo $item->numero; ?></td>
                                                        <td contenteditable="true"><?php echo $item->contabilidad; ?></td>
                                                        <td contenteditable="true"><?php echo $item->direccion; ?></td>
                                                        <td contenteditable="true"><?php echo $item->telefono; ?></td>
                                                        <td contenteditable="true"><?php echo $item->observacion; ?></td>
                                                        <td contenteditable="true"><?php echo $item->fecha; ?></td>
                                                        <td contenteditable="true"><?php echo $item->tesoreria; ?></td>
                                                        <td contenteditable="true"><?php echo $item->pedi_matricula; ?></td>
                                                        <td contenteditable="true"><?php echo $item->modalidad; ?></td>
                                                        <td contenteditable="true"><?php echo $item->tipo_presupuesto; ?></td>
                                                        <td contenteditable="true"><?php echo $item->unidad_respon; ?></td>
                                                        <td contenteditable="true"><?php echo $item->proyecto; ?></td>
                                                        <td contenteditable="true"><?php echo $item->estado; ?></td>
                                                        <td contenteditable="true"><?php echo $item->nro_pac; ?></td>
                                                        <td contenteditable="true"><?php echo $item->nro_exp; ?></td>
                                                        <td contenteditable="true"><?php echo $item->total; ?></td>
                                                        <td contenteditable="true"><?php echo $item->pagado; ?></td>
                                                                                            <td>
                                                                                    </tr>
                                                                <?php endforeach; ?>
                                                <?php endif; ?>
