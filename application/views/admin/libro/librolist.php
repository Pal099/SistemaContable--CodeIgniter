        ...
        async function generarPDF() {
            ...
            try {
                ...
                function agregarDatosMayor(entrada) {
                    ...
                    // Asegurarte de que los valores no sean null o undefined antes de llamar a toLocaleString
                    var debe = entrada.Debe || 0;
                    var haber = entrada.Haber || 0;
                    var saldoA = entrada.Saldo_Anterior || 0;
                    var saldo = entrada.Saldo || 0;
                    ...
                    row.push(saldoA.toLocaleString('es-PY', {
                        minimumFractionDigits: 0,
                        maximumFractionDigits: 0
                    }));
