...
class Deposito_obligaciones extends CI_Controller
{
	...
	public function update()
	{
		...
		if ($this->Diario_obli_model->save_num_asiave($idobli, $data)) {
			redirect(base_url() . "obligaciones/deposito_obligaciones");
		} else {
			$this->session->set_flashdata("error", "No se pudo guardar la informacion");
			redirect(base_url() . "obligaciones/deposito_obligaciones/add" . $idobli);
		}
	}
	...
	public function delete($id)
	{
		...
		echo "obligaciones/deposito_obligaciones";
	}
}