    ...
    public function store() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($this->Niveles_model->save($data)) {
                // Configurar el mensaje de éxito en la sesión flash
                $this->session->set_flashdata("success", "Nivel guardado con éxito");
                // Redirigir al usuario de vuelta a la lista de niveles
                redirect(base_url() . "mantenimiento/niveles/add?success=1");
            } else {
