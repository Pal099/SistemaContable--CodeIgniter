...
class Pdf_pago_num_asi extends CI_Controller {
    ...
    public function index($numero_asiento)
    {
        ...
        $datos['ultimosDatos'] = $this->Pdf_model->obtenerDatos_pago_numasi($numero_asiento);
        $this->load->view('layouts/header');
        $this->load->view('fpdf_pago_num_asi', $datos);
        
        //$this->load->view('layouts/footer');
    }

    public function pdf_pago_obli_num_asi($numero_asiento)
    {
        require_once APPPATH . 'third_party/fpdf/fpdf.php';
    
        $this->load->model("Pdf_model"); // Load the model first
        $pdf = new FPDF();
        $datosProveedor = $this->Pdf_model->obtenerDatos_pago_numasi($numero_asiento);
        $datos['ultimosDatos'] = $this->Pdf_model->obtenerDatos_pago_numasi($numero_asiento);
