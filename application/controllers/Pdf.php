...
//----------------//------------------------------------
    ...
    $pdf->setY(112);
    $pdf->setX(10);
    $pdf->Rect(6,$pdf->GetY(), 198, 87);
    $pdf->SetFont('Arial', 'B', 12);
    $pdf->Ln();

         //----------------//------------------------------------

    //Rectangulo para Imputación Retencion aplicada
    $pdf->setY(203);
    $pdf->setX(6);
    $pdf->Rect(6,$pdf->GetY(), 198, 90);
    $pdf->SetFont('Arial', 'B', 12);
    $pdf->Ln();
...
$pdf->setY(273);
$pdf->setX(7);
$pdf->Cell(3, 3, "Dr. Sebastian A. Benitez Gonzalez: ");
