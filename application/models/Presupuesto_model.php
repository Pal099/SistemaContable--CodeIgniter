...
public function getPresu($id_uni_respon_usu) {
	$this->db->select('pre.*, c.DescripcionCuentaContable as descripcion, ff.nombre as fuente_de_financiamiento, of.nombre as origen_de_financiamiento, pr.nombre as programa');
