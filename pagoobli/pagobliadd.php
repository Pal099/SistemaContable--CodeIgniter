  ...
  <link rel="stylesheet" type="text/css" href="assets/style.css">
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo base_url();?>obligaciones/Pago_de_obligaciones">Pago de Obligaciones</a></li>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form id="formPrincipal" action="<?php echo base_url();?>obligaciones/Pago_de_obligaciones/store" method="POST">
